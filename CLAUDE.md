...
## Estado actual
Esqueleto del proyecto: Django + DRF configurados, modelos base de `market_data` con su migración inicial y admin registrado. Todavía sin ingesta de precios, sin scoring y sin el agente de IA -- eso son los próximos pasos, uno por vez, con tests antes de seguir.
